XPages Extension Library サンプル 日本語版
=======================================

内容
----
このプロジェクトは 、XPages Extension Library Japan Project の一環として、 XPages Extension Library のモジュールに含まれているサンプル NSF を翻訳しています。
詳細については OpenNTF の [XPages Extension Library Project](http://www.openntf.org/internal/home.nsf/project.xsp?action=openDocument&name=XPages%20Extension%20Library%20Japan) のページをご覧ください。
